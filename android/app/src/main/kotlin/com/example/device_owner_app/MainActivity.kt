...
import io.flutter.plugins.GeneratedPluginRegistrant
import com.example.device_locker.DeviceLockerPlugin

class MainActivity : FlutterActivity(), ActivityAware {
    private lateinit var deviceLockerPlugin: DeviceLockerPlugin

    override fun configureFlutterEngine(@NonNull flutterEngine: FlutterEngine) {
        super.configureFlutterEngine(flutterEngine)
        GeneratedPluginRegistrant.registerWith(flutterEngine)
        deviceLockerPlugin = DeviceLockerPlugin()
        flutterEngine.plugins.add(deviceLockerPlugin)
    }

    override fun onAttachedToActivity(binding: ActivityPluginBinding) {
        deviceLockerPlugin.onAttachedToActivity(binding)
    }

    override fun onDetachedFromActivity() {
        deviceLockerPlugin.onDetachedFromActivity()
    }

    override fun onDetachedFromActivityForConfigChanges() {
        deviceLockerPlugin.onDetachedFromActivityForConfigChanges()
    }

    override fun onReattachedToActivityForConfigChanges(binding: ActivityPluginBinding) {
        deviceLockerPlugin.onReattachedToActivityForConfigChanges(binding)
    }
    ...
    //         putExtra(DevicePolicyManager.EXTRA_ADD_EXPLANATION, "Device admin permission is required to lock/unlock the device.")
    //     }
    //     startActivityForResult(intent, REQUEST_CODE_ENABLE_ADMIN)
    // }
